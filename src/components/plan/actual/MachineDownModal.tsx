...
// status unless the caller passes an explicit initialEventType (the card's
// "Breakdown" pill always does, forcing the report screen even from a
// machine that's already down). Replacing a machine is a separate concern —
